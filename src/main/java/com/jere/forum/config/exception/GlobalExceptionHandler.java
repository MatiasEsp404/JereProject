...
import com.jere.forum.config.exception.runtime.WrongResponseException;
import com.jere.forum.config.security.common.ErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  private ErrorResponse buildErrorResponse(HttpStatus httpStatus, String message,
    ...
    return ErrorResponse.builder().statusCode(httpStatus.value()).message(message)
