...
public class UpdateUserIntegrationTest extends BigTest {
  ...
  public void shouldUpdateUserWhenUserHasAdminRole() throws Exception {
    ...
    mockMvc
        .perform(patch(Paths.USERS + Paths.ID, String.valueOf(randomUser.getId()))
            .content(objectMapper
                .writeValueAsString(UpdateUserRequest.builder().lastName("Gordon").build()))
  ...
  public void shouldReturnNotFoundErrorResponseWhenUserNotExist() throws Exception {
    ...
    mockMvc
        .perform(patch(Paths.USERS + Paths.ID, nonExistUserId)
            .content(objectMapper
                .writeValueAsString(UpdateUserRequest.builder().lastName("Gordon").build()))
            .contentType(MediaType.APPLICATION_JSON)
            .header(HttpHeaders.AUTHORIZATION, getAuthorizationTokenForAdminUser()))
    ...
    mockMvc
        .perform(patch(Paths.USERS + Paths.ID, String.valueOf(randomUser.getId()))
            .content(objectMapper.writeValueAsString(
                UpdateUserRequest.builder().password("0123456789101112131415").build()))
            .contentType(MediaType.APPLICATION_JSON)
            .header(HttpHeaders.AUTHORIZATION, getAuthorizationTokenForAdminUser()))
  ...
  public void shouldReturnBadRequestWhenPasswordIsTooShort() throws Exception {
    ...
    mockMvc
        .perform(patch(Paths.USERS + Paths.ID, String.valueOf(randomUser.getId()))
            .content(objectMapper
                .writeValueAsString(UpdateUserRequest.builder().password("0123").build()))
            .contentType(MediaType.APPLICATION_JSON)
            .header(HttpHeaders.AUTHORIZATION, getAuthorizationTokenForAdminUser()))
        .andExpect(jsonPath("$.statusCode", equalTo(400)))
        .andExpect(jsonPath("$.message", equalTo("Invalid input data.")))
  ...
  public void shouldReturnBadRequestWhenFirstNameContainsNumbers() throws Exception {
    ...
    mockMvc
        .perform(patch(Paths.USERS + Paths.ID, String.valueOf(randomUser.getId()))
            .content(objectMapper
                .writeValueAsString(UpdateUserRequest.builder().firstName("G0rd0n").build()))
            .contentType(MediaType.APPLICATION_JSON)
            .header(HttpHeaders.AUTHORIZATION, getAuthorizationTokenForAdminUser()))
        .andExpect(jsonPath("$.statusCode", equalTo(400)))
        .andExpect(jsonPath("$.message", equalTo("Invalid input data.")))
  ...
  public void shouldReturnBadRequestWhenLastNameContainsNumbers() throws Exception {
    ...
    mockMvc
        .perform(patch(Paths.USERS + Paths.ID, String.valueOf(randomUser.getId()))
            .content(objectMapper
                .writeValueAsString(UpdateUserRequest.builder().lastName("Fr33m4n").build()))
            .contentType(MediaType.APPLICATION_JSON)
            .header(HttpHeaders.AUTHORIZATION, getAuthorizationTokenForAdminUser()))
        .andExpect(jsonPath("$.statusCode", equalTo(400)))
        .andExpect(jsonPath("$.message", equalTo("Invalid input data.")))
